...
- Files: kebab-case with role suffixes as used throughout (`admin.controller.js`, `deployment.service.js`, `user.model.js`); kebab-case for utilities and directories.
