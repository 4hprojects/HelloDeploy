...
| Session cookie   | `Secure; HttpOnly; SameSite=Strict`                     | Failed | A fresh check after publishing `v0.1.1` still reports `missing secure`; confirm Render deployed commit `eee3440c9e47aa60a95736883d48fdbc307af36e` with the supported start command and production configuration, then redeploy and recheck |
