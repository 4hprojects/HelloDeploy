...
| Web and worker               | Both repository-run processes are active                           | Failed  | The reviewed PM2 web remains active; P2 paused and inventoried the queue, and the isolated worker stays deliberately inactive until routing and controlled-resume gates pass             |
...
| Upgrade and rollback         | In-place candidate failure restores the live pilot                 | Blocked | P0 backup and rollback inputs pass; isolated candidate units, queue control, and executed rollback remain                                                                                |
