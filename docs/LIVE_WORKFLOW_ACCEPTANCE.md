...
| Constrained routing helper   | Helper socket and managed application route directory are active   | Blocked | Protected route storage and the helper lifecycle pass, but persistent helper activation and route transactions belong to P2                                                              |
