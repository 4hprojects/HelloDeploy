...
| Web and worker               | Both repository-run processes are active                           | Failed  | The reviewed PM2 web remains active; the isolated worker is deliberately inactive until P2 pauses and inventories queues                                                                 |
