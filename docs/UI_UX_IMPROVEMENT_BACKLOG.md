...
| ----- | ------- | -------- | -------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------- |
| UX-01 | Pending | P1       | Confirmation dialogs | Replace browser default confirmations with a custom modal dialog.    | Reuse existing `data-confirm` attributes; support forms and links; trap focus; close on Escape.                                  | Destructive/admin actions show accessible modal and no longer call browser `confirm()`.              | 2026-07-01T20:30:11+08:00 |
